...
export const footerLinks = {
  ...
  contactInfo: [
    { name: "Phone", value: "+248 4224 200" },
    { name: "Email", value: "info@drmd.sc" },
    { name: "Address", value: "DRMD Building, Victoria, Seychelles" },
  ],
}
...
export const aboutContent = {
  ...
  description:
    "The Disaster Risk Management Division (DRMD) is the primary government agency responsible for coordinating and integrating disaster risk reduction and management efforts in Seychelles.",
  mission:
  ...
  vision: "A disaster-resilient Seychelles with safer, adaptive, and disaster-ready communities.",
...
export const contactInfo = {
  address: "DRMD Headquarters, Independence Avenue, Victoria, Seychelles",
  phone: "+248 4224 200",
  email: "info@drmd.sc",
