                            ...
                            <div className="card h-100 border-0 shadow-sm">
                                ...
                                <div className="card-body">
                                    ...
                                    <p>Construction of enhanced drainage systems in
                                        flood-prone areas of Victoria to mitigate
                                            ...
                                            <div className="col-md-9">
                                                <div className="document-info p-3">
                                                    ...
                                                    <p className="document-description mb-2" style={{ fontSize: 13, color: '#666' }}>
                                                        ...
                                                        disaster scenarios in Victoria
                                                        district.
                                                    </p>
                            ...
                            <div className="row">
                                <div className="col-lg-6 mb-4">
                                    <div className="card h-100 shadow-sm">
                                        <div className="card-img-top p-2 bg-light">
                                            <img src="assets/img/maps/Victoria_Seychelles_map.svg.png" className="img-fluid rounded" alt="Victoria Flood Risk Map" />
                                        </div>
                                        <div className="card-body">
                                            <h5 className="card-title">Victoria Flood Risk
                                                Map</h5>
                                            <p className="card-text">Detailed map showing
                                                flood risk zones across Victoria with
                                ...
                                <div className="col-lg-6 mb-4">
                                    <div className="card h-100 shadow-sm">
                                        ...
                                        <div className="card-body">
                                            <h5 className="card-title">Victoria Evacuation
                                                Routes</h5>
                            ...
                            <div className="card border-0 shadow-sm h-100">
                                ...
                                <div className="card-body">
                                    <div className="contact-info mb-4">
                                        ...
                                        <p>Victoria District Administration Building<br />
                                            3rd Floor, Disaster Management Wing<br />
                                            Sir William Newton Street<br />
                                            Victoria, Seychelles</p>
                                    </div>
                                    <div className="contact-info mb-4">
                                ...
                                <div className="col-md-4 mb-4">
                                    <div className="emergency-contact-card p-3 rounded" style={{ border: '1px solid rgba(245, 153, 70, 0.3)' }}>
                                        ...
                                        <ul className="list-unstyled mb-0">
                                            ...
                                            <li className="mb-2"><strong>Victoria Hospital:</strong> <a href="tel:+23059781000">+230 5978-1000</a></li>
                                ...
                                <div className="col-md-4 mb-4">
                                    <div className="emergency-contact-card p-3 rounded" style={{ border: '1px solid rgba(245, 153, 70, 0.3)' }}>
                                        ...
                                        <ul className="list-unstyled mb-0">
                                            ...
                                            <li className="mb-2"><strong>Victoria Fire Station:</strong> <a href="tel:+23059784000">+230 5978-4000</a></li>
                                ...
                                <div className="col-md-4 mb-4">
                                    <div className="emergency-contact-card p-3 rounded" style={{ border: '1px solid rgba(245, 153, 70, 0.3)' }}>
                                        ...
                                        <ul className="list-unstyled mb-0">
                                            ...
                                            <li className="mb-2"><strong>Victoria Police HQ:</strong> <a href="tel:+23059785000">+230 5978-5000</a></li>
