    ...
    <div className="page-wrapper">
      ...
      <div className="container mt-5">
        ...
        <div className="section-title style3 text-center mb-40">
          ...
          <p>Access official documents, infographics, interactive maps, and forms to support disaster preparedness, response, and recovery activities across Seychelles.</p>
        </div>
        {/* Resource Filter Bar */}
              ...
              <div className="row">
                <div className="col-md-4 mb-3 mb-md-0">
                  <select className="form-select" id="district-filter" style={{ height: 50, borderRadius: 25, border: '1px solid rgba(51, 143, 122, 0.3)', paddingLeft: 20 }}>
                    ...
                    <option>Anse aux Pins</option>
                    <option>Anse Royale</option>
                    <option>Cascade</option>
                    <option>Praslin</option>
                    <option>La Digue</option>
                    <option>Outer Islands</option>
                  </select>
                </div>
                          ...
                          <div className="col-md-8">
                            <div className="document-info p-4">
                              ...
                              <p className="document-description mb-3" style={{ fontSize: 14, color: '#666' }}>
                                Comprehensive planning document detailing national response protocols for various disaster scenarios including cyclones, floods, and other emergencies across Seychelles.
                              </p>
                    ...
                    <div className="col-lg-6 mb-4">
                      <div className="map-card bg-white rounded shadow-sm overflow-hidden h-100">
                        <div className="map-preview position-relative" style={{ height: 250, backgroundColor: '#f5f5f5' }}>
                          <div id="seychelles-hazard-map" className="w-100 h-100" style={{ backgroundImage: 'url("assets/img/maps/hazard-map-preview.jpg")', backgroundSize: 'cover', backgroundPosition: 'center' }} />
                        ...
                        <div className="map-info p-4">
                          <h3 className="map-title mb-2" style={{ fontSize: 20 }}>Seychelles Multi-Hazard Risk Map</h3>
                          <p className="map-description mb-3" style={{ fontSize: 14, color: '#666' }}>
                            Interactive map showing areas at risk from various hazards including cyclones, flooding, landslides and earthquakes across all districts of Seychelles.
                          </p>
                    ...
                    <div className="col-lg-6 mb-4">
                      <div className="map-card bg-white rounded shadow-sm overflow-hidden h-100">
                        ...
                        <div className="map-info p-4">
                          ...
                          <p className="map-description mb-3" style={{ fontSize: 14, color: '#666' }}>
                            Detailed map showing areas prone to flooding based on historical data and topographical analysis across Seychelles.
                          </p>
                          <div className="map-actions">
