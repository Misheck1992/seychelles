  ...
  'infographics': {
    ...
    resourceItems: [
      ...
      },
      {
        ...
        description: 'Visual guide to evacuation routes and safe zones across Seychelles.',
    ...
    resourceItems: [
      {
        ...
        description: 'Comprehensive plan detailing response protocols for various disaster scenarios in Seychelles.',
    ...
    resourceItems: [
      {
        ...
        description: 'Detailed map showing flood-prone areas and risk levels across Seychelles.',
