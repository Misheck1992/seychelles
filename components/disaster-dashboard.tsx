  ...
  return (
    <section className="py-12 bg-primary">
      <div className="container">
        <h2 className="section-title text-white">Seychelles Disaster Status Dashboard</h2>

        <div className="bg-white/90 p-4 rounded-lg mb-8">
          <h3 className="text-center text-lg font-medium mb-2">Seychelles Disaster Risk Map</h3>
